...
namespace QuanLyDT.Repository.ADO
{
    public class LoaiCuocRepository : ILoaiCuocRepository
    {
        ...
        {
            int row = DataProvider.Instane.ExecuteNonQuery("EXEC dbo.SP_TaoLoaiCuoc @MaLoaiCuoc , @TG_BatDau , @TG_KetThuc , @GiaCuoc ",
                                        new object[] {loaiCuoc.MaGiaCuoc, loaiCuoc.TGBD, loaiCuoc.TGKT,
                          loaiCuoc.Giacuoc1});
            return row > 0;
        }
        ...
        {
            int row = DataProvider.Instane.ExecuteNonQuery("EXEC dbo.SP_UpdateLoaiCuoc @MaLoaiCuoc , @TG_BatDau , @TG_KetThuc , @GiaCuoc ",
                          new object[] { loaiCuoc.MaGiaCuoc,loaiCuoc.TGBD, loaiCuoc.TGKT, loaiCuoc.Giacuoc1});
            return row > 0;
        }
    }
}
